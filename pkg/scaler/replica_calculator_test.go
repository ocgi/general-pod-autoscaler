...
import (
	...
	autoscalingv1alpha1 "github.com/ocgi/general-pod-autoscaler/pkg/apis/autoscaling/v1alpha1"
...
type metricInfo struct {
	name         string
	levels       []int64
	singleObject *autoscalingv1alpha1.CrossVersionObjectReference
...
func (tc *replicaCalcTestCase) prepareTestCMClient(t *testing.T) *cmfake.FakeCustomMetricsClient {
	...
	fakeCMClient.AddReactor("get", "*", func(action core.Action) (handled bool, ret runtime.Object, err error) {
		...
		s := runtime.NewScheme()
		s.AddKnownTypes(schema.GroupVersion{Group: "apps", Version: "v1"}, &v12.Deployment{})
		s.AddKnownTypes(schema.GroupVersion{Group: "", Version: "v1"}, &v1.Pod{}, &v1.PodList{})
...
func (tc *replicaCalcTestCase) runTest(t *testing.T) {
	...
	replicaCalc := NewReplicaCalculator(metricsClient, informer.Lister(), defaultTestingTolerance, defaultTestingDelayOfInitialReadinessStatus, defaultTestingDelayOfInitialReadinessStatus)
...
func TestGroupPods(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			readyPodCount, ignoredPods, missingPods, _ := groupPods(tc.pods, tc.metrics, tc.resource, defaultTestingCPUInitializationPeriod,
